...
const CAMINHOS = {
  ...
  qrcode: 'M2.5 2.5h6v6h-6zM4.7 4.7h1.6v1.6h-1.6zM15.5 2.5h6v6h-6zM17.7 4.7h1.6v1.6h-1.6zM2.5 15.5h6v6h-6zM4.7 17.7h1.6v1.6h-1.6zM11 2.5v3.2M11 11h3.2M20.5 11v3.2M11 17.5v4M15.5 15.5h2.2v2.2h-2.2zM19.7 15.5h1.8v1.8h-1.8zM15.5 19.7h1.8v1.8h-1.8zM19.7 19.7h1.8v1.8h-1.8z',
}
...
export function BotaoRelatorio({ onClick, rotulo = 'Relatório', disabled }) {
  return (
    <button className="btn btn-secondary" onClick={onClick || (() => window.print())} disabled={disabled}>
