...
const ALIASES = {
  ...
  previsaoEntrega: ['data prevista de entrega', 'previsao de entrega', 'previsao entrega'],
  excluido: ['excluido'],
...
export async function lerPlanilhaSuprimentos(arquivo) {
  ...
  for (let r = linhaCabecalho + 1; r <= faixa.e.r; r++) {
    ...
    itens.push({
      ...
      previsao_entrega: colunas.previsaoEntrega >= 0 ? celParaISO(cel(r, colunas.previsaoEntrega)) : null,
